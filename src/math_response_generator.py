        ...
        try:
            ...
            prompt_context = {
                ...
                "prompt_constraints": [
                    ...
                    "for dual-only requests, place the dual formulation in exactly two wrapped display-math blocks: the first must be a single aligned block with (D), the objective on its own line, s.t. on its own line, and one inequality per line; the second must contain only sign restrictions",
